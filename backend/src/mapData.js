...
let LEVEL_3 = [...LEVEL_2];
LEVEL_3.push({ type: 'player', colour: 'red', x: 0, y: 8 });
LEVEL_3.push({ type: 'player', colour: 'blue', x: 23, y: 8 });
LEVEL_3.push({ type: 'machine', colour: 'red', x: 0, y: 9 });
LEVEL_3.push({ type: 'machine', colour: 'blue', x: 23, y: 9 });
